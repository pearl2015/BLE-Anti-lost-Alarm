 ...
 * @{
 */
//JHG #define DM_DISABLE_LOGS        /**< Enable this macro to disable any logs from this module. */
                                                 ...
                                                 dm_handle_t const       * p_handle)
{
    ...
    DM_LOG("[DM]: --> gatts_context_store\r\n");
		DM_LOG("[DM]: sd_ble_gatts_sys_attr_get(%s)//JHG\r\n", sys_data);
...
static __INLINE api_result_t gatts_context_apply(dm_handle_t * p_handle)
{
       ...
       )
    {
		...
		DM_LOG("[DM]: sd_ble_gatts_sys_attr_set(%s) //JHG\r\n", p_gatts_context);
...
api_result_t dm_security_setup_req(dm_handle_t * p_handle)
{
    ...
    {
				DM_LOG("[DM]: sd_ble_gap_authenticate //JHG\r\n");
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            if (m_connection_table[index].bonded_dev_id != DM_INVALID_ID)
            {
                ...
                DM_DUMP((uint8_t *)p_enc_info, sizeof(ble_gap_enc_info_t));
						...
						DM_LOG("[DM]: >> sd_ble_gap_sec_info_reply(%s) // JHG\r\n", p_enc_info->ltk);
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            ...
            event.event_id = DM_EVT_SECURITY_SETUP;
						DM_LOG("[DM]: sd_ble_gap_sec_params_reply(BLE_GAP_SEC_STATUS_SUCCESS) //JHG \r\n");
