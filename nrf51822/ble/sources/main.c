...
#define APP_COMPANY_IDENTIFIER           0x0075                            /**< Company identifier for Apple Inc. as per www.bluetooth.org. */
#define APP_MAJOR_VALUE                  0x09, 0x07                        /**< Major value used to identify Beacons. */ 
...
{
	//JHG EYSFCNZXX External Clock = 32 MHz
