                         ...
                         ble_gatts_char_handles_t      * p_handles)
{
    ...
    char_md.char_props.read  = 1;//Read Enable
		//Characteristic User Description : 0x2901
    char_md.p_char_user_desc = NULL;
		//Characteristic Presentation Format : 0x2904
    char_md.p_char_pf        = NULL;
    char_md.p_user_desc_md   = NULL;
		//Client Characteristic Configuration Descriptor(CCCD) Metadata : 0x2902
    char_md.p_cccd_md        = NULL;
		//Server Characteristic Configuration metadata : 0x2903
...
SERV_LOG("[SERV][dis]: sd_ble_gatts_characteristic_add(uuid : 0x%x %s)\r\n", uuid, p_char_value);
...
SERV_LOG("[SERV][dis]: sd_ble_gatts_service_add(BLE_GATTS_SRVC_TYPE_PRIMARY)\r\n");
